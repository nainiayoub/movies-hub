...
<body>
<%
	String idDirecteur = request.getParameter("idDirector");
	if(idDirecteur == null){
		idDirecteur = (String)request.getAttribute("idDirector");
	}
	//visitor
...
<div class="container" style="margin-top:110px;">
  ...
  <path fill-rule="evenodd" d="M0 1a1 1 0 011-1h14a1 1 0 011 1v14a1 1 0 01-1 1H1a1 1 0 01-1-1V1zm4 0h8v6H4V1zm8 8H4v6h8V9zM1 1h2v2H1V1zm2 3H1v2h2V4zM1 7h2v2H1V7zm2 3H1v2h2v-2zm-2 3h2v2H1v-2zM15 1h-2v2h2V1zm-2 3h2v2h-2V4zm2 3h-2v2h2V7zm-2 3h2v2h-2v-2zm2 3h-2v2h2v-2z" clip-rule="evenodd"/>
</svg> - <%=director.getDirectorName()%></div>
		...
		<div class="panel-body">
			...
			<form method="post" action="myServlet" class="form">
				...
				<div class="form-group">
					<label for="idDirect">ID Directeur: <%=director.getDirectorId()%></label>
					<input type="hidden" name="idDirect" placeholder="ID Directeur" class="form-control" value="<%=director.getDirectorId()%>">
				</div>
				
				<div class="form-group">
					<label for="dname">Directeur : </label>
					<input type="text" name="dname" value="<%=director.getDirectorName() %>" placeholder="Nom et Prénom du Directeur" class="form-control">
				</div>
						
			   	<div class="form-group">
			    	<label for="nationality">Nationalité : </label>
					<input type="text" name="nationality" value="<%=director.getDirectorNat() %>" placeholder="Nationalité du Directeur" class="form-control">
				</div>	
				<div class="form-group">
			    	<label for="poster">Image du Directeur : </label>
					<input type="text" name="image" value="<%=director.getImage() %>" placeholder="Lien d'image en ligne du Directeur" class="form-control">
				</div>	
				</td>
				<td style="padding-right: ">
				<img alt="<%=director.getDirectorName()%>" src="<%=director.getImage()%>" class="img-thumbnail" width="210px" height="320px" style="float: right;dispaly: inline-block; border: 2px solid #333"/>		
				</td>
				</tr>
				</table>
				
			
				<button type="submit" class="btn btn-success" name="updateDirector">
