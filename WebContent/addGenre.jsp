...
<%
	...
	DAO dao = new DAO();
	Genre genre = dao.getLastGenreRow();
%>
...
<div class="container" style="margin-top:90px;">
	<div class="panel panel-default">
		...
		Ajouter Genre - <svg class="bi bi-film" width="0.9em" height="0.9em" viewBox="0 0 16 16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
  <path fill-rule="evenodd" d="M0 1a1 1 0 011-1h14a1 1 0 011 1v14a1 1 0 01-1 1H1a1 1 0 01-1-1V1zm4 0h8v6H4V1zm8 8H4v6h8V9zM1 1h2v2H1V1zm2 3H1v2h2V4zM1 7h2v2H1V7zm2 3H1v2h2v-2zm-2 3h2v2H1v-2zM15 1h-2v2h2V1zm-2 3h2v2h-2V4zm2 3h-2v2h2V7zm-2 3h2v2h-2v-2zm2 3h-2v2h2v-2z" clip-rule="evenodd"/>
</svg></div>
		...
		<div class="panel-body">
			<form method="post" action="myServlet" class="form">
				...
				<div class="form-group">
					...
					<input type="text" name="idGenre" placeholder="ID Genre (ID Genre précédent <% if(genre != null) out.println(genre.getGenreId());%>)" class="form-control" required>
				</div>
				
				<div class="form-group">
				<label for="genreType">Genre : </label>
					<input type="text" name="genreType" placeholder="Type du genre" class="form-control" required>
				</div>
			
				<button type="submit" class="btn btn-success" name="addGenre">
